    ...
    <Box sx={{ p: '2em', backgroundColor: '#f6f6f6' }}>
      ...
      <Box
        ...
        {vehicles.map((vehicle) => (
          <Card key={vehicle.id} sx={{ backgroundColor: 'primary.light', maxWidth: view === 'grid' ? {xs: 220, md: 250} : '100%', marginBottom: 2, boxShadow: 2 }}>
            <CardActionArea sx={{ display: 'flex', flexDirection: 'column', alignItems: 'start', height: '100%' }} >
              <CardMedia sx={{ boxShadow: 1, height: view === 'grid' ? 200 : 400, objectFit: 'fill', width: '100%' }} component="img" image={vehicle.fotos[0]} />
